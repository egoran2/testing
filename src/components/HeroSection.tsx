        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.h1
              ...
              className="font-heading font-bold text-4xl lg:text-6xl leading-tight mb-6"
            >
              {t('headline')}
            </motion.h1>
            ...
            >
              <Link href="/quiz" className="btn-secondary inline-flex items-center justify-center space-x-2">
                <span>{t('cta')}</span>
                <ArrowRight className="w-5 h-5" />
              </Link>
              
              <Link href="/contact" className="btn-outline bg-transparent border-white text-white hover:bg-white hover:text-blue-600">
                {t('ctaSecondary')}
              </Link>
            </motion.div>
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-blue-100">98% Success Rate</span>
              </div>
              <div className="flex items-center space-x-2">
                <CheckCircle className="w-5 h-5 text-green-400" />
                <span className="text-sm text-blue-100">Legal Compliance</span>
              </div>
              <div className="flex items-center space-x-2">
                <CheckCircle className="w-5 h-5 text-green-400" />
            ...
            <div className="relative">
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">500+ Approved</p>
              ...
              >
                <div className="text-center">
                  <p className="font-bold text-2xl text-blue-600">3-6</p>
